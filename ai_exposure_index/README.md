...
> **Attribution.** The per-task AI scores in this folder were generated by Claude
> (Anthropic, Opus 4.8) following the rubric in `rubric/rubric.md`, then calibrated
> against human review. All other parts of the project (data pipeline, SQL,
> warehouse, and report) are the author's own work.
